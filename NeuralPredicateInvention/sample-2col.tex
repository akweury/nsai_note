...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{NeuralPredicateInvention/img/area_8.png} 
...
\begin{figure*}[ht]
  \centering
  \includegraphics[width=\linewidth]{NeuralPredicateInvention/img/pi_workflow.PNG} 
...
\begin{figure*}[H]
  \centering
    \begin{minipage}{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-0.png}
        \caption{Caption}\label{label-a}
    \end{minipage}
    \begin{minipage}{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-1.png}
        \caption{Caption}\label{label-b}
    \end{minipage}
    \begin{minipage}{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-2.png}
        \caption{Caption}\label{label-b}
    \end{minipage}
        \begin{minipage}[b]{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-3.png}
        \caption{Caption}\label{label-a}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-4.png}
        \caption{Caption}\label{label-b}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-5.png}
        \caption{Caption}\label{label-b}
    \end{minipage}
        \begin{minipage}[b]{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-6.png}
        \caption{Caption}\label{label-a}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-7.png}
        \caption{Caption}\label{label-b}
    \end{minipage}
    \begin{minipage}[b]{.3\textwidth}
        \includegraphics[width=\textwidth]{NeuralPredicateInvention/img/mce/mce-8.png}
        \caption{Caption}\label{label-b}
    \end{minipage}
  \caption{Pipeline of NSFR with PI module.}
  \label{fig:mce}
...
\begin{table}
  ...
  \begin{tabular}{ccl}
    \toprule
    Module & Accuracy & Require epochs\\
    \midrule
    $\alpha$ILP &       0.925 & 0 \\
    $\alpha$ILP + PI &  1.0 & 40\\
    \bottomrule
