...
\begin{figure}[!htb]
	...
	\subfigure[Triangle Same]{\includegraphics[width=0.24\textwidth]{img/3DKP/two_pairs.png}} 
...
\begin{table}
	...
	\begin{tabular}{c|c|c|c|c|c|c|c|c}
		\hline
		\toprule
		\multirow{2}*{Dataset} & \multirow{2}*{Patterns} &  \multirow{2}*{Iterations} &\multicolumn{2}{c|}{Times} & \multicolumn{2}{c|}{Accuracy} & \multicolumn{2}{c}{\# of Ne-Preds} \\
		\cline{4-9}
		 & & & $ \alpha$ILP & NeSy-$ \pi $ &$ \alpha$ILP & NeSy-$ \pi $&$ \alpha$ILP & NeSy-$ \pi $\\
		\hline
		\multirow{4}*{Kandinsky} &
		red-triangle &	3  & 0 	    & & & & 	0	    &  4           \\
		&two-pairs   & 	2	& 	0 	& & & & 0	& 3	        \\
		&check-mark &		& 	0 	& & & & 0	&  	     \\
		&cross-mark &		& 	0 	& & & & 0	&  	       \\
		\hline
		\multirow{4}*{3D Scenes} &
		three same & 2  & 0 	    & & &  & 	0	    &       1      \\
		&two-pairs  & 2		& 	0 	& & & & 0	& 	3        \\
		&cross mark  & 	2	& 	0 	& & & & 0	& 	   3     \\
		&check mark  & 	1	& 	0 	& & & & 0	& 	     2   \\
